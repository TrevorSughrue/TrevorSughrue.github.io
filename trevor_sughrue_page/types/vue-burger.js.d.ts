...
export interface BubbleConstructor {
  // extends VueConstructor {
  data: () => {
    propsToPass: {
      isOpen?: boolean;
...
export interface PushConstructor {
  // extends VueConstructor {
  data: () => {
    bodyOldStyle: string;
  };
...
export interface PushRotateConstructor {
  // extends VueConstructor {
  data: () => {
    bodyOldStyle: string;
    appOldStyle: string;
...
export interface ScaleDownConstructor {
  // extends VueConstructor {
  data: () => {
    bodyOldStyle: string;
    appOldStyle: string;
...
export interface ScaleRotateConstructor {
  // extends VueConstructor {
  data: () => {
    bodyOldStyle: string;
    appOldStyle: string;
...
export interface FallDownConstructor {
  // extends VueConstructor {
  data: () => {
    bodyOldStyle: string;
    propsToPass: {
...
export interface ElasticConstructor {
  // extends VueConstructor {
  data: () => {
    bodyOldStyle: string;
    propsToPass: {
